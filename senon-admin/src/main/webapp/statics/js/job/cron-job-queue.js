(function($) {
	...
	$(function() {
		LTS.colFormatter.optFormat = function (v, row) {
            ...
            return '<a class="btn btn-default btn-sm glyphicon glyphicon-pause job-suspend-btn" jobId="' + row['jobId'] + '" taskTrackerNodeGroup="' + row['taskTrackerNodeGroup'] + '" href="javascript:;"></a>' +
            '<a class="btn btn-danger btn-sm glyphicon glyphicon-remove job-del-btn" jobId="' + row['jobId'] + '" taskTrackerNodeGroup="' + row['taskTrackerNodeGroup'] + '" href="javascript:;"></a>';
        }
